...
Many years later (2014), I took this as an opportunity to learn Objective-C and the the Apple App Store processes.  Of course, I couldn’t reuse the assembly code from the Amiga version, but I was able to reuse the graphics and sound. That’s why the iOS version looks almost exactly like the Amiga version.
